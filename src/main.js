...
// Create OrbitControls for the canvasshialian canvas and disable zoom
const controlss = new OrbitControls(camera, canvasshialian);
controlss.enableZoom = false; // Disable zoom
...
function animate() {
  ...
  objectGroup.rotation.x = -55.0;
  objectGroup.rotation.y += 0.0;
